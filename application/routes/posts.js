...
router.post('/create', isLoggedIn, uploader.single('videoUpload'), function (req, res, next) {
    ...
    try {
        const { resultObj, _ } = await.db.query(`INSERT INTO posts (title, description, video, thumbnail, fk_user_id) VALUE 
